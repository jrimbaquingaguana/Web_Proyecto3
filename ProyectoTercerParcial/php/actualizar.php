...
if (isset($_GET['id'])) {
    ...
    $consultaCodigo = "SELECT codigo_registro FROM despachador WHERE id = $idProducto AND tipo = 'PRODUCTO'";
    ...
    if ($dataCodigo['codigo_registro']) {
        ...
        $consultaActualizar="UPDATE despachador SET codigo_registro=NULL   WHERE id = $idProducto AND tipo = 'PRODUCTO' "
